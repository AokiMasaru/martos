all:
	...
	riscv32-unknown-elf-gcc -g -T src/link.ld build/start.o build/trap_vector.o build/setTrapVector.o  build/main.o -o martos -march=rv32i_zicsr -mabi=ilp32 -fPIC -nostdlib -nostartfiles
