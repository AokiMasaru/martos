...
all:
	...
	riscv32-unknown-elf-gcc -c -g -Isrc/kernel/include -o build/systimer.o src/kernel/systimer.c               -march=rv32i_zicsr -mabi=ilp32 -fPIC -nostdlib -nostartfiles
	...
	riscv32-unknown-elf-gcc -c -g -Isrc/kernel/include -o build/task_sync.o src/kernel/task_sync.c               -march=rv32i_zicsr -mabi=ilp32 -fPIC -nostdlib -nostartfiles
